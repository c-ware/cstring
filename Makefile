OBJS=./src/cstring.o 
TESTS=./tests/find ./tests/loadf ./tests/concat ./tests/strip ./tests/finds ./tests/concats ./tests/endswiths ./tests/startswith ./tests/init ./tests/endswith ./tests/strips ./tests/startswiths 
